...
public class CoreBankingDataManagementMenu_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "io.diffblue.corebanking.ui.menu.CoreBankingDataManagementMenu"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CoreBankingDataManagementMenu_ESTest_scaffolding.class.getClassLoader() ,
      "io.diffblue.corebanking.transaction.TransactionException",
      "io.diffblue.corebanking.CoreBankingException",
      "io.diffblue.corebanking.Util",
      "io.diffblue.corebanking.compliance.rules.ComplianceRuleBalanceAboveOrEqualToZero",
      ...
      "io.diffblue.corebanking.compliance.rules.ComplianceRule",
      "io.diffblue.corebanking.ui.menu.CoreBankingDataManagementMenu",
      "io.diffblue.corebanking.transaction.CashTransaction",
      "io.diffblue.corebanking.datamanagement.ReadFromDB",
      "io.diffblue.corebanking.CoreBanking",
      "io.diffblue.corebanking.account.Account$AccountState",
      "io.diffblue.corebanking.client.Client",
      "io.diffblue.corebanking.datamanagement.WriteToDB",
      "io.diffblue.corebanking.compliance.CheckCompliance",
      "io.diffblue.corebanking.ui.menu.Menu",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CoreBankingDataManagementMenu_ESTest_scaffolding.class.getClassLoader()); 
